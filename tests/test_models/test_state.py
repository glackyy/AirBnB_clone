...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        st = State()
        st.id = "123456"
        st.created_at = st.updated_at = date
        ststr = st.__str__()
        self.assertIn("[State] (123456)", ststr)
        self.assertIn("'id': '123456'", ststr)
        self.assertIn("'created_at': " + date_repr, ststr)
        self.assertIn("'updated_at': " + date_repr, ststr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        st = State(id="345", created_at=date_iso, updated_at=date_iso)
