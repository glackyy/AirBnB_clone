...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_two_placeaces_unique_ids(self):
        placeace1 = Place()
        placeace2 = Place()
        self.assertNotEqual(placeace1.id, placeace2.id)

    def test_two_placeaces_different_created_at(self):
        placeace1 = Place()
        sleep(0.05)
        placeace2 = Place()
        self.assertLess(placeace1.created_at, placeace2.created_at)

    def test_two_placeaces_different_updated_at(self):
        placeace1 = Place()
        sleep(0.05)
        placeace2 = Place()
        self.assertLess(placeace1.updated_at, placeace2.updated_at)
